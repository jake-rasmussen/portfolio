      ...
      <div className="flex justify-center space-y-24 p-6 pb-16 pt-[20rem] md:pt-[27.5rem]">
        <div className="lg:mx-24">
          ...
          <div className="flex flex-col items-center content">
            ...
            <div>
              <div className="avatar mt-8 float-left mr-6 hidden md:flex">
                <div className="h-[20rem] w-[20rem] lg:h-[25rem] lg:w-[25rem] rounded-3xl shadow-xl">
                  <Image
                    src={Headshot}
                    alt={""}
              ...
              <p className="m-8 text-left text-xl text-white text-left xl:ml-10 lg:text-2xl">
                Thank you for checking out my portfolio website! 
                I'm from a small town right outside of Philadelphia, and now am in Baltimore studying 
                Computer Science at Johns Hopkins University. From a very young age, I've always
                had a fascination with technology. I loved playing around with the Raspberry Pi, and
                ...
                feel free to reach out to me via the contact form. Thank you again for checking out my
                website!
              </p>
            </div>
          </div>
